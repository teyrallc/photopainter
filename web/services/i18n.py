...
TRANSLATIONS = {
    ...
    "en": {
        ...
        "hotspot_active": "Vignette-Setup hotspot is active",
        "hotspot_hint": "Connect your phone to Vignette-Setup (password vignette123), then pick your home network below.",
    ...
    "zh": {
        ...
        "hotspot_active": "Vignette-Setup 熱點運作中",
        "hotspot_hint": "將手機連上 Vignette-Setup（密碼 vignette123），再於下方選擇家中網路。",
        "continue_setup": "繼續設定",
